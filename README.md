...
For visual example of the inheritances as well as an example of the outputs of each child class see ![Inheritance_Path_Figure.png](https://github.com/Ben7892/Code_Example/blob/main/Inheritance_Path_Figure-1.pdf) \
